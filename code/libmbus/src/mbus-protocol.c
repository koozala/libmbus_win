...
mbus_frame_calc_length(mbus_frame* frame)
{
	if (frame)
	{
		frame->length1 = frame->length2 = (unsigned char)calc_length(frame);
	}
...
mbus_data_product_name(mbus_data_variable_header* header)
{
	...
	if (header)
	{
		...
		if (manufacturer == mbus_manufacturer_id("ABB"))
		{
			...
			{
			case 0x02:
				strcpy_s(buff, sizeof(buff), "ABB Delta-Meter");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("ACW"))
		{
			...
			{
			case 0x09:
				strcpy_s(buff, sizeof(buff), "Itron CF Echo 2");
				break;
			case 0x0A:
				strcpy_s(buff, sizeof(buff), "Itron CF 51");
				break;
			case 0x0B:
				strcpy_s(buff, sizeof(buff), "Itron CF 55");
				break;
			case 0x0E:
				strcpy_s(buff, sizeof(buff), "Itron BM +m");
				break;
			case 0x0F:
				strcpy_s(buff, sizeof(buff), "Itron CF 800");
				break;
			case 0x14:
				strcpy_s(buff, sizeof(buff), "Itron CYBLE M-Bus 1.4");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("AMT"))
		{
			...
			{
			case 0x80:
				strcpy_s(buff, sizeof(buff), "Aquametro CALEC MB");
				break;
			case 0xC0:
				strcpy_s(buff, sizeof(buff), "Aquametro CALEC ST");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("BEC"))
		{
			if (header->medium == MBUS_VARIABLE_DATA_MEDIUM_ELECTRICITY)
			{
				...
				{
				case 0x00:
					strcpy_s(buff, sizeof(buff), "Berg DCMi");
					break;
				case 0x07:
					strcpy_s(buff, sizeof(buff), "Berg BLMi");
					break;
				}
			}
			else if (header->medium == MBUS_VARIABLE_DATA_MEDIUM_UNKNOWN)
			{
				...
				{
				case 0x71:
					strcpy_s(buff, sizeof(buff), "Berg BMB-10S0");
					break;
				}
			}
		}
		else if (manufacturer == mbus_manufacturer_id("EFE"))
		{
			...
			{
			case 0x00:
				strcpy_s(buff, sizeof(buff), ((header->medium == 0x06) ? "Engelmann WaterStar" : "Engelmann / Elster SensoStar 2"));
				break;
			case 0x01:
				strcpy_s(buff, sizeof(buff), "Engelmann SensoStar 2C");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("ELS"))
		{
			...
			{
			case 0x02:
				strcpy_s(buff, sizeof(buff), "Elster TMP-A");
				break;
			case 0x0A:
				strcpy_s(buff, sizeof(buff), "Elster Falcon");
				break;
			case 0x2F:
				strcpy_s(buff, sizeof(buff), "Elster F96 Plus");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("ELV"))
		{
			...
			case 0x1C:
			case 0x1D:
				strcpy_s(buff, sizeof(buff), "Elvaco CMa10");
				break;
			case 0x32:
			case 0x33:
			case 0x34:
			...
			case 0x3A:
			case 0x3B:
				strcpy_s(buff, sizeof(buff), "Elvaco CMa11");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("EMH"))
		{
			...
			{
			case 0x00:
				strcpy_s(buff, sizeof(buff), "EMH DIZ");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("EMU"))
		{
			if (header->medium == MBUS_VARIABLE_DATA_MEDIUM_ELECTRICITY)
			{
				...
				{
				case 0x10:
					strcpy_s(buff, sizeof(buff), "EMU Professional 3/75 M-Bus");
					break;
				}
			}
		}
		else if (manufacturer == mbus_manufacturer_id("GAV"))
		{
			if (header->medium == MBUS_VARIABLE_DATA_MEDIUM_ELECTRICITY)
			{
				...
				case 0x2F:
				case 0x30:
					strcpy_s(buff, sizeof(buff), "Carlo Gavazzi EM24");
					break;
				case 0x39:
				case 0x3A:
					strcpy_s(buff, sizeof(buff), "Carlo Gavazzi EM21");
					break;
				case 0x40:
					strcpy_s(buff, sizeof(buff), "Carlo Gavazzi EM33");
					break;
				}
			}
		}
		else if (manufacturer == mbus_manufacturer_id("GMC"))
		{
			...
			{
			case 0xE6:
				strcpy_s(buff, sizeof(buff), "GMC-I A230 EMMOD 206");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("KAM"))
		{
			...
			{
			case 0x01:
				strcpy_s(buff, sizeof(buff), "Kamstrup 382 (6850-005)");
				break;
			case 0x08:
				strcpy_s(buff, sizeof(buff), "Kamstrup Multical 601");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("SLB"))
		{
			...
			{
			case 0x02:
				strcpy_s(buff, sizeof(buff), "Allmess Megacontrol CF-50");
				break;
			case 0x06:
				strcpy_s(buff, sizeof(buff), "CF Compact / Integral MK MaXX");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("HYD"))
		{
			...
			{
			case 0x28:
				strcpy_s(buff, sizeof(buff), "ABB F95 Typ US770");
				break;
			case 0x2F:
				strcpy_s(buff, sizeof(buff), "Hydrometer Sharky 775");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("JAN"))
		{
			if (header->medium == MBUS_VARIABLE_DATA_MEDIUM_ELECTRICITY)
			{
				...
				{
				case 0x09:
					strcpy_s(buff, sizeof(buff), "Janitza UMG 96S");
					break;
				}
			}
		}
		else if (manufacturer == mbus_manufacturer_id("LUG"))
		{
			...
			{
			case 0x02:
				strcpy_s(buff, sizeof(buff), "Landis & Gyr Ultraheat 2WR5");
				break;
			case 0x03:
				strcpy_s(buff, sizeof(buff), "Landis & Gyr Ultraheat 2WR6");
				break;
			case 0x04:
				strcpy_s(buff, sizeof(buff), "Landis & Gyr Ultraheat UH50");
				break;
			case 0x07:
				strcpy_s(buff, sizeof(buff), "Landis & Gyr Ultraheat T230");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("LSE"))
		{
			...
			{
			case 0x99:
				strcpy_s(buff, sizeof(buff), "Siemens WFH21");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("NZR"))
		{
			...
			{
			case 0x01:
				strcpy_s(buff, sizeof(buff), "NZR DHZ 5/63");
				break;
			case 0x50:
				strcpy_s(buff, sizeof(buff), "NZR IC-M2");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("RAM"))
		{
			...
			{
			case 0x03:
				strcpy_s(buff, sizeof(buff), "Rossweiner ETK/ETW Modularis");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("REL"))
		{
			...
			{
			case 0x08:
				strcpy_s(buff, sizeof(buff), "Relay PadPuls M1");
				break;
			case 0x12:
				strcpy_s(buff, sizeof(buff), "Relay PadPuls M4");
				break;
			case 0x20:
				strcpy_s(buff, sizeof(buff), "Relay Padin 4");
				break;
			case 0x30:
				strcpy_s(buff, sizeof(buff), "Relay AnDi 4");
				break;
			case 0x40:
				strcpy_s(buff, sizeof(buff), "Relay PadPuls M2");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("RKE"))
		{
			...
			{
			case 0x69:
				strcpy_s(buff, sizeof(buff), "Ista sensonic II mbus");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("SBC"))
		{
			...
			case 0x10:
			case 0x19:
				strcpy_s(buff, sizeof(buff), "Saia-Burgess ALE3");
				break;
			case 0x11:
				strcpy_s(buff, sizeof(buff), "Saia-Burgess AWD3");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("SEN"))
		{
			...
			{
			case 0x0B:
				strcpy_s(buff, sizeof(buff), "Sensus PolluTherm");
				break;
			case 0x0E:
				strcpy_s(buff, sizeof(buff), "Sensus PolluStat E");
				break;
			case 0x19:
				strcpy_s(buff, sizeof(buff), "Sensus PolluCom E");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("SON"))
		{
			...
			{
			case 0x0D:
				strcpy_s(buff, sizeof(buff), "Sontex Supercal 531");
				break;
			}
		}
		...
		else if (manufacturer == mbus_manufacturer_id("SVM"))
		{
			...
			{
			case 0x08:
				strcpy_s(buff, sizeof(buff), "Elster F2 / Deltamess F2");
				break;
			case 0x09:
				strcpy_s(buff, sizeof(buff), "Elster F4 / Kamstrup SVM F22");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("TCH"))
		{
			...
			{
			case 0x26:
				strcpy_s(buff, sizeof(buff), "Techem m-bus S");
				break;
			}
		}
		else if (manufacturer == mbus_manufacturer_id("ZRM"))
		{
			...
			{
			case 0x81:
				strcpy_s(buff, sizeof(buff), "Minol Minocal C2");
				break;
			case 0x82:
				strcpy_s(buff, sizeof(buff), "Minol Minocal WR3");
				break;
			}
		}
...
//     kW * 10   011000     18        Â°C* 10-3       111000     38
...
mbus_data_fixed_unit(int medium_unit_byte)
{
	...
	case 0x38:
		snprintf(buff, sizeof(buff), "1e-3 Â°C");
		break;
	case 0x39:
...
// Cooling load meter (Volume measured at flow temperature: inlet) â™£  0000 1011        0B
// Heat (Volume measured at flow temperature: inlet)                  0000 1100        0C
// Heat / Cooling load meter â™£                                        0000 1101        OD
...
mbus_data_error_lookup(int error)
{
	...
	case MBUS_ERROR_DATA_TOO_MANY_DIFES:
		snprintf(buff, sizeof(buff), "More than 10 DIFEÂ´s");
		break;

	case MBUS_ERROR_DATA_TOO_MANY_VIFES:
		snprintf(buff, sizeof(buff), "More than 10 VIFEÂ´s");
		break;
...
mbus_data_variable_record_xml(mbus_data_record* record, int record_cnt, int frame_cnt, mbus_data_variable_header* header)
{
	...
	if (record)
	{
		...
		{
			gmtime_s(&timeinfo, &(record->timestamp));
...
mbus_frame_select_secondary_pack(mbus_frame* frame, char* address)
{
	...
	strncpy_s(tmp, sizeof(tmp), &address[14], 2); tmp[2] = 0;
	val = strtol(tmp, NULL, 16);
	frame->data[7] = val & 0xFF;

	strncpy_s(tmp, sizeof(tmp), &address[12], 2); tmp[2] = 0;
	val = strtol(tmp, NULL, 16);
	frame->data[6] = val & 0xFF;

	strncpy_s(tmp, sizeof(tmp), &address[8], 4); tmp[4] = 0;
	val = strtol(tmp, NULL, 16);
